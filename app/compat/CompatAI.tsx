...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1623] text-[#D8f3ff] p-4 sm:p-8 pb-28 font-sans antialiased">
      ...
      <div className="fixed bottom-2 right-2 text-xs text-[#D8f3ff] opacity-50">
        Version 25.8.10
      </div>
    </div>
  );
